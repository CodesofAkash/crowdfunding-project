...
const SignUp = () => {
    ...
    return (
        <div className='text-white py-6 container mx-auto'>
            <h1 className='text-center font-bold text-3xl'>SignUp to Get your fans to support you.</h1>
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <button type='submit' className="w-full text-white bg-primary-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign Up</button>
              </form>
          </div>
      </div>
    </div>
            </div>
            <div className="socialLoginBtns flex justify-center items-center min-h-fit">
                <div className="flex gap-5 min-h-fit p-10">


                    <button  onClick={() => { signIn("google") }}
                        className="flex items-center text-black hover:bg-gray-900 hover:text-white border-gray-300 rounded-lg shadow-md max-w-sm px-5 py-4 text-md gap-3 font-medium bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
