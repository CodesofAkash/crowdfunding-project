  ...
  return (
    <>
      <div className="text-white p-4 flex flex-col gap-4 justify-center items-center h-[44vh]">
        <div className="font-bold text-5xl flex justify-center items-center gap-10">Buy me a Chai. <span><Image className="w-20 h-25" src="/chai.gif"></Image></span></div>
      ...
      <div className="text-white container mx-auto py-32">
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full p-2 text-black h-[88px] w-[88px]" src="/man.gif" alt="" />
            <p className="font-bold">Fans want to help</p>
            <p>Your fans are available for you to help you.</p>
          </div>
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full text-black h-[88px] w-[88px]" src="/coin.gif" alt="" />
            <p className="font-bold">Fans want to help</p>
            <p>Your fans are available for you to help you.</p>
          </div>
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <Image className="bg-slate-400 rounded-full p-2 text-black h-[88px] w-[88px]" src="/group.gif" alt="" />
            <p className="font-bold">Fans want to help</p>
            <p>Your fans are available for you to help you.</p>
          </div>
        </div>
