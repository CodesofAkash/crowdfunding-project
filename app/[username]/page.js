        ...
        <>
            {session &&
                <div className='flex flex-col justify-start items-start'>
                    <div className="cover size-fit"><img className='size-fit' src="https://c10.patreonusercontent.com/4/patreon-media/p/campaign/2854321/0713ec8c651540289edc2f90a40df6ae/eyJ3IjoxOTIwLCJ3ZSI6MX0%3D/35.gif?token-time=1717459200&amp;token-hash=nKcV76S8X2qvdY54iQDDYeuNKkUivifYpkGLkuYsVlg%3D" alt="" /></div>
                    <div className='h-fit w-full flex flex-col justify-start items-center gap-10'>
                        <div className='w-full h-fit'><div className='relative w-full h-24 flex justify-center items-center'><img className='size-32 z-20 rounded-lg absolute top-[-30px]' src={session.user.image} display="block" alt="" /></div></div>
                    ...
                    <div className='w-full h-fit flex justify-center items-center gap-16 p-10'>
                        <div className='min-h-[270px] mx-5 w-1/2 h-fit p-4 bg-slate-800 rounded-lg'>
                            ...
                            <ul className='flex flex-col gap-7 text-gray-300 ml-10'>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>John</span> contributed <span className='text-white'>$20</span> with a message</div><div><span className='text-white'>"Great job!"</span></div></div></li>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>Emily</span> contributed <span className='text-white'>$30</span> with a message</div><div><span className='text-white'>"You're doing amazing work!"</span></div></div></li>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>Michael</span> contributed <span className='text-white'>$25</span> with a message</div><div><span className='text-white'>"Keep it up!"</span></div></div></li>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>Emma</span> contributed <span className='text-white'>$15</span> with a message</div><div><span className='text-white'>"You're making a difference!"</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>Daniel</span> contributed <span className='text-white'>$40</span> with a message</div><div><span className='text-white'>"Your work inspires us!"</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>Olivia</span> contributed <span className='text-white'>$10</span> with a message</div><div><span className='text-white'>"Thank you for your efforts!"</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>James</span> contributed <span className='text-white'>$50</span> with a message</div><div><span className='text-white'>"Your work is inspiring!"</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><img className='w-10' src="/avatar.gif" alt="" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>Ava</span> contributed <span className='text-white'>$35</span> with a message</div><div><span className='text-white'>"Keep doing what you're doing!"</span></div></div></li>
...
export default MyAccount
>>>>>>> 4ed57a05bbf4fe2151bb1f70c5340936a6d2a183
