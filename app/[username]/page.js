                    ...
                    <div className='w-full h-fit flex justify-center items-center gap-16 p-10'>
                        <div className='min-h-[270px] mx-5 w-1/2 h-fit p-4 bg-slate-800 rounded-lg'>
                            ...
                            <ul className='flex flex-col gap-7 text-gray-300 ml-10'>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;ohn</span> contributed <span className='text-white'>&quot;20</span> with a message</div><div><span className='text-white'>&quot;Great job!&quot;</span></div></div></li>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;mily</span> contributed <span className='text-white'>&quot;30</span> with a message</div><div><span className='text-white'>&quot;You're doing amazing work!&quot;</span></div></div></li>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;ichael</span> contributed <span className='text-white'>&quot;25</span> with a message</div><div><span className='text-white'>&quot;Keep it up!&quot;</span></div></div></li>
                                    <li className='flex gap-4 items-center justify-start border-b-2 border-gray-700'><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;mma</span> contributed <span className='text-white'>&quot;15</span> with a message</div><div><span className='text-white'>&quot;You're making a difference!&quot;</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;aniel</span> contributed <span className='text-white'>&quot;40</span> with a message</div><div><span className='text-white'>&quot;Your work inspires us!&quot;</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;livia</span> contributed <span className='text-white'>&quot;10</span> with a message</div><div><span className='text-white'>&quot;Thank you for your efforts!&quot;</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;ames</span> contributed <span className='text-white'>&quot;50</span> with a message</div><div><span className='text-white'>&quot;Your work is inspiring!&quot;</span></div></div></li>
                                    <li className={`${!show && "hidden"} flex gap-4 items-center justify-start border-b-2 border-gray-700`}><span><Image className='w-10' src="/avatar.gif" alt="error" /></span><div className='flex flex-col gap-2'><div><span className='text-white'>&quot;va</span> contributed <span className='text-white'>&quot;35</span> with a message</div><div><span className='text-white'>&quot;Keep doing what you're doing!&quot;</span></div></div></li>
